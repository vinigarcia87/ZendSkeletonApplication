...
$.fn.equalHeights = function(px) {
    $(this).each(function(){
        ...
        if ($.browser.msie) { $(this).children().css({'height': currentTallest}); } // Actually, all version of ie need this
...
$.fn.equalWidths = function(px) {
    $(this).each(function(){
        ...
        if ($.browser.msie) { $(this).children().css({'width': currentTallest}); } // Actually, all version of ie need this
